...
import { HorizontalLayout, VerticalLayout } from "./js/layout.mjs"
import { TouchHandler } from "./js/touchhandler.mjs";
import { Slider } from "./js/slider.mjs";
import { MoveByTouch, createUpath } from "./js/moveByTouch.mjs";
...
window.onload = () => {
    ...
    const moveable = MoveByTouch(ctx, createUpath());
    touchwidgets.addTouchWidget(moveable);
    ...
    mainLayout.addChild(moveable, 10);
